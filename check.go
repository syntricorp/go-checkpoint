...
import (
	...
	"github.com/syntricorp/go-cleanhttp"
)
...
type CheckParams struct {
	...
	// is set. Within SyntriCorp products, this is ONLY USED when the user
...
func Check(p *CheckParams) (*CheckResponse, error) {
	...
	u.Scheme = "https"
	u.Host = "checkpoint-api.syntricorp.com"
	...
	req.Header.Set("User-Agent", "SyntriCorp/go-checkpoint")
